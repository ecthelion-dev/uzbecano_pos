...
export const ru: Record<TranslationKey, string> = {
  ...
  'drawer.reasonPlaceholder': 'Причина — обязательно',
  'drawer.notePlaceholder': 'Комментарий (необязательно)',
  'drawer.categoryPlaceholder': 'На что? (например: Молоко)',
  'drawer.needCategory': 'Укажите, на что потрачено',
