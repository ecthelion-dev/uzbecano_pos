...
export const DEFAULT_OFFLINE_PRODUCTS: DBProduct[] = [
  { id: 'prod_1', name: 'Toshkent Oshi (Choyxona)', category: 'Milliy Taomlar', price: 38000, description: 'Sarxil qo\'y go\'shti va zardak sabzi bilan' },
  { id: 'prod_2', name: 'Manti (Go\'shtli 4dona)', category: 'Milliy Taomlar', price: 32000, description: 'Maydalangan mol go\'shti va piyozli' },
  ...
  { id: 'prod_6', name: 'Pizza Pepperoni', category: 'Fast Food & Pizza', price: 75000, description: 'Pitsereya usulida pishirilgan' },
  ...
  { id: 'prod_9', name: 'Coca-Cola 1.5L', category: 'Ichimliklar & Choy', price: 15000, description: 'Muzdek gazlangan ichimlik' },
