...
export const en: Record<TranslationKey, string> = {
  ...
  'drawer.reasonPlaceholder': 'Reason — required',
  'drawer.notePlaceholder': 'Note (optional)',
  'drawer.categoryPlaceholder': 'What for? (e.g. Milk)',
  'drawer.needCategory': 'Say what it was spent on',
