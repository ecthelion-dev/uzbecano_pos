...
export const uz = {
  ...
  'drawer.reasonPlaceholder': 'Sababi — majburiy',
  'drawer.notePlaceholder': 'Izoh (ixtiyoriy)',
  'drawer.categoryPlaceholder': 'Nimaga? (masalan: Sut)',
  'drawer.needCategory': 'Nimaga ketganini yozing',
